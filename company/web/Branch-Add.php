                ...
                <section class="wrapper" style='margin-top:60px;display:inline-block;width:100%;padding:15px 0 0 15px;'>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Branch Details</h1>                            </div>
                   ...
                   <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Add Branch</h2>
...
<form action="" method="POST" enctype="multipart/form-data"> 
  ...
  <br>
 <label style=" float:left;margin-right:3%;"> Branch</label>
    <input type="text"  autocomplete="off" required style="width:40%; float:left; margin-right:3%;" placeholder="Branch" name="branch" value="" class="form-control">
...
if($obj->Add_branch($branch)==1)
{	

echo "<script type='text/javascript'>
alert('Sylabus Added to Database!!');
</script>";
