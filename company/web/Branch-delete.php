		...
		$sql->execute();
			...
			?> 
                       ...
                       <th><?php echo $row['ID']; ?></th>
                          <th><?php echo $row['branchs']; ?></th>
                        
                      <td><a href="Branch-delete.php?id=<?php echo $row['ID']; ?>" class="btn btn-danger">Delete </a></td>
...
{
	echo "<script>window.location='Branch-delete.php?id1=done';</script>";
}
