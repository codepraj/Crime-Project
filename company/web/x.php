                ...
                <section class="wrapper" style='margin-top:60px;display:inline-block;width:100%;padding:15px 0 0 15px;'>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Delete Notes</h1>                            </div>
<?php        
		if(isset($_GET['id1']))
		{
		if($_GET['id1']=="done")
                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                ...
                                <h2 class="title pull-left">Delete Notes</h2>
                                            ...
                                            <table cellspacing="0" id="tech-companies-1" class="table table-small-font table-bordered table-striped">
                                                <thead>
                                                    <tr>
                                                         ...
                                                         <th data-priority="1">Subject</th> <th data-priority="1">Branch</th>
                                                         <th data-priority="1">Description</th>
                 
                 <th data-priority="1">Semister</th>                                        
  ...
  $obj= new Connections();// Now we create the object of AdminConnection class and through that object we are going to call connection
			$id=$_SESSION['id'];
  $sql = $obj->db->prepare("select * from  assignment	 where uploader_id='$id'");
		...
		$sql->execute();
			...
			?> 
                       ...
                       <th><?php echo $row['ID']; ?></th>
                          <th><?php echo $row['assignment_title']; ?></th>
                          <th><?php  
	 ...
	 $sql1->execute(); while($row1 = $sql1->fetch(PDO::FETCH_ASSOC)) {
                           ...
                           <th><?php  
							echo $row['descrption'];
							?></th>
                          <th><?php echo $row['semister']; echo "Semister"; ?></th>
                        
                      <td><a href="Students-assignment-details.php?id=<?php echo $row['ID']; ?>" class="btn btn-primary">View Submitted Student's Assignment</a></td>
...
{
	echo "<script>window.location='Notes-delete.php?id1=done';</script>";
}
