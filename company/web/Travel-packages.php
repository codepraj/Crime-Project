...
<head>
 ...
 <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
     <div class="page-title">
         ...
         <div class="pull-left">
             <h1 class="title">View Tour Listing</h1>        
              </div>
 ...
 <div class="col-lg-12">
     <section class="box ">
         <header class="panel_header">
             ...
             <h2 class="title pull-left">Tour List</h2>
...
<tr>
     ...
     <th data-priority="1">Tour Name</th>
     <th data-priority="2">
     Area</th>
     <th data-priority="3">Season </th>
...
<?php	
  ...
  $sql = $obj->db->prepare("select * from tour_package");
		$sql->execute();
		if($sql->rowCount()=='0'){echo '<h1> No Result Found</h1>';}
		while($row = $sql->fetch(PDO::FETCH_ASSOC)) {
		?> 
    <tr>
    <th><?php echo $row['tour_title'];  ?></th>
     <th><?php echo $row['area']; ?>  </th>
     <th><?php echo $row['season']; ?>  </th>
     <th><?php echo $row['type']; ?>  </th>
    
       <td>
       <a href="Travels-Packages-details.php?id=<?php echo $row['ID']; ?>" class="btn btn-primary"> View </a>
	   </td>
