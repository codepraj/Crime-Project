  ...
  function delete($id,$table)
    {
	   ...
	   function Update_for_application($stud_id,$comp_id,$table,$vertype,$onbehalf,$edu_type,$applied_id,$course_id,$verification_comes_from)
 {
$sql =$this->db->prepare("INSERT INTO $table( `stud_id`, `comp_id`, `clg_verification`, `company_verification`, `stud_verification`,`ver_type`,`on_behalf`,`edu_type`,`applied_id`,`course_id`,`verification_comes_from`) VALUES (:stud_id,:comp_id,'0','0','1',:vertype,:onbehalf,:edu_type,:applied_id,:course_id,:verification_comes_from);");

$sql->bindParam(':stud_id', $stud_id);
$sql->bindParam(':comp_id', $comp_id);
$sql->bindParam(':vertype', $vertype);
$sql->bindParam(':onbehalf', $onbehalf);
$sql->bindParam(':edu_type', $edu_type);
$sql->bindParam(':applied_id', $applied_id);
$sql->bindParam(':course_id', $course_id);
$sql->bindParam(':verification_comes_from', $verification_comes_from);
