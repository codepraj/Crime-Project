...
if(isset($_POST['username']) && isset($_POST['password']))
        ...
        {
            $obj= new Connections();// Now we create the object of AdminConnection class and through that object we are going to call connection
	$sql = $obj->db->prepare("select * from faculty where emp_id='$name'");
	$sql->execute();
	while($row = $sql->fetch(PDO::FETCH_ASSOC)) {
	 ...
	 echo "<script>alert('Welcome $namess');</script>";
...
<center>
<h1 style="background-color:#FFF;padding:10px;"> Faculty Section</h1>
</center>
                <form action="" name="loginform" id="loginform"  method="post">
                   ...
                   <p class="submit">
                     ...
                     <p class="submit">
                        <a href="Register.php" name="wp-submit" id="wp-submit" class="btn btn-orange btn-block">Register</a>
                    </p>
                </form>
