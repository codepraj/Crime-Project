...
<html>
<head>
<title>Online Assignment Student Platform </title>
<!-- Bootstrap -->
...
if($obj->insert_student($first_name,$middle_name,$last_name,$email,$password,$contact,$branch,$college,$add,$city,$gender,$dob,$year)==1)
{
/*$obj= new Connections(); 
...
<span><input type="text" required name="m_name" class="form-control" id="userName">
</span>
						    </div>
                            <div>
						    	<span>Last Name</span>
...
$sql->execute();
?> 
<select name="branch" class="span6" required class="form-control">
...
<option value="Bhartiya Mahavidyalaya Amravati">Bhartiya Mahavidyalaya Amravati</option>
...
<span><input type="text" required name="add" class="form-control" id="userName">
                            ...
                            <div>
						    	<span>City</span>
<span><input type="text" name="city" class="form-control" id="userName">
</span>
						    </div>
