...
return 0;
 ...
 function proof_of_work($blockchainid,$minid,$student_id,$course_id)
 {
$sql =$this->db->prepare("INSERT INTO proof_of_work(`blockchain_id`,`miners_id`,`status`,`stud_id`,`course_id`) VALUES(:blockchainid,:minid,'1',:student_id,:course_id)");
...
return 0;
 ...
 function proof_of_work1($blockchainid,$minid,$student_id,$course_id)
 {
$sql =$this->db->prepare("INSERT INTO proof_of_work(`blockchain_id`,`miners_id`,`status`,`stud_id`,`course_id`) VALUES(:blockchainid,:minid,'0',:student_id,:course_id)");
