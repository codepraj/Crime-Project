...
<?php        
                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12"> <a href="create-question.php" class="btn btn-primary" style="float:right;">Ask Query</a>
 ...
 <?php	
  ...
  $sql = $obj->db->prepare("select * from  forum");
