...
<head>
    ...
    <body class=" "><!-- START TOPBAR -->
     ...
     $comid=$_SESSION['sid'];    
$sql1 = $obj->db->prepare("select * from company_student_verification where stud_id='$comid' group by comp_id");
    $sql1->execute();
      while($row1 = $sql1->fetch(PDO::FETCH_ASSOC)) {
            $stud_id=$row1['comp_id'];
  $sql = $obj->db->prepare("select * from company where ID='$stud_id'");
        ...
        $sql->execute();
            ...
            ?> 
                                                    <tr>
  <th style="width: 150px;"><img height="120" width="120" src="../images/company/<?php echo $row['company_logo']; ?>"></th>
                        <th><?php echo $row['company_name']; ?></th>
                        <td><?php echo $row['company_contact']; ?></td>
                        <td><?php echo $row['company_email']; ?></td>
                       
      <td><?php if($row1['stud_verification']=='0')
