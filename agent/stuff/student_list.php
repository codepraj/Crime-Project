...
<head>
                ...
                <section class="wrapper" style='margin-top:60px;display:inline-block;width:100%;padding:15px 0 0 15px;'>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Delete Notices</h1>                            </div>
                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                ...
                                <h2 class="title pull-left">Delete Notice</h2>
  ...
  $obj= new Connections();
  $sql = $obj->db->prepare("select * from  student");
  $sql->execute();
	while($row = $sql->fetch(PDO::FETCH_ASSOC)) {
			...
			?> 
                       ...
                       <th><?php echo $row['ID']; ?></th>
                          ...
                          <th><?php echo $row['Student_contact']; ?></th>
                         <th><?php echo $row['Student_email'];  ?></th>
                        
                      <td><a href="Notification-delete.php?id=<?php echo $row['ID']; ?>" class="btn btn-danger">Delete </a></td>
