...
<a href="course_details.php?id=<?php echo $ID; ?>" style="color: white;">
...
<span style="background-color:green;">  Proof of Work Success Status: <?php echo $count; ?></span><br>
<span style="background-color:red;">  Proof of Work Failure Status: <?php echo $count11; ?></span>
<br>
<a class="btn btn-success" href="certificate.php?id=<?php echo $stud_id; ?>&courseid=<?php echo $course_id; ?>" target="_blank">
GET Certificate
  </a>
    <?php }else{ ?>
<?php if($university_approve_status==1){ ?>
<span style="background-color:green;">Persuing </span>
<?php }else{ ?>

<span style="background-color:green;">Pending for Approval  </span>
