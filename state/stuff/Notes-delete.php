                ...
                <section class="wrapper" style='margin-top:60px;display:inline-block;width:100%;padding:15px 0 0 15px;'>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Delete Assignment</h1>                            </div>
<?php        
		if(isset($_GET['id1']))
		{
		if($_GET['id1']=="done")
                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                ...
                                <h2 class="title pull-left">Delete Assignment</h2>
  ...
  $sql = $obj->db->prepare("select * from  assignment	 where uploader_id='$id'");
	 ...
	 $sql1->execute(); while($row1 = $sql1->fetch(PDO::FETCH_ASSOC)) {
                      ...
                      <td><a href="Notes-delete.php?id=<?php echo $row['ID']; ?>" class="btn btn-danger">Delete </a></td>
