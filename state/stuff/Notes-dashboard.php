...
<link rel="shortcut icon" href="assets/images/favicon.png" type="image/x-icon" />    <!-- Favicon -->
  ...
  $sql = $obj->db->prepare("select * from  courses where college_id='$uniid'  AND type_course='main'");
...
<a href="course_details.php?id=<?php echo $ID; ?>">
                                 ...
                                 <div class="col-lg-3 col-md-4 col-xs-6 col-sm-4">
                                        ...
                                        <div class="tile-progress bg-info" style="height: 450px;">
                                            <div class="content">
  ...
  $obj= new Connections();$uniid=$_SESSION['iid'];
  $sql = $obj->db->prepare("select * from  courses where college_id='$uniid' AND type_course='sub'");
