...
<?php 
  ...
  $sql = $obj->db->prepare("select * from  guest_message where resolved_status='1' AND state='$state' AND city='$city'");
...
<?php 
  ...
  $sql = $obj->db->prepare("select * from  guest_message where resolved_status='0' AND state='$state' AND city='$city'");
