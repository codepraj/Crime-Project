...
if($spamProbability==0 && $spam==0){
            ...
            ?> 
                      ...
                      <td><a href="Guest-Message.php?id=<?php echo $row['ID']; ?>" class="btn btn-danger">Delete </a> <a href="Guest-Message.php?stid=<?php echo $row['ID']; ?>" class="btn btn-success">Resolved </a></td>
...
$id=$_GET['stid'];
$table="guest_message";
if($obj->deleteupdate($id,$table)==1)
{
    echo "<script//>window.location='Guest-Message.php?id11=done';</script>";
}
