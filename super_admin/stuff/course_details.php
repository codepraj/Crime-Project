...
<!--       
 ...
 <input type="hidden" name="course_id" value="<?php echo $_GET['id']; ?>">  
  ...
  <table cellspacing="0" id="tech-companies-1" border="1" class="">
      <thead>
          <tr>
 ...
 $sql1 = $obj->db->prepare("select * from  applied_courses where course_id='$id'");
  ...
  <th><img src="../images/student_profile/<?php echo $row['Student_photo']; ?>" height="150" width="150"></th>
     <th><?php echo $row['Student_name']; ?><br><?php echo $row['Student_contact']; ?><br><?php echo $row['Student_email'];  ?><br>
     <?php echo $row['age']; ?> Year
     </th>
 ...
 <th>
   <form action="" method="post">
 <input type="hidden" value="<?php echo $row1['ID'];  ?>" name="stud_id">
 <input type="submit"  class="btn btn-primary"
 <?php if($row1['university_approve_status']==1){ echo "disabled 
  value='Approved'";}else{echo "value='Approve'";} ?>
 >
 </form></th>
          </tr>      
<?php }} ?>          
...
$course_id=$_GET['id'];
$sql1="select * from applied_courses where ID='$stud_id' AND university_approve_status='1'";
$query=mysql_query($sql1);
$count=mysql_num_rows($query);
if($count==0){
$sql="UPDATE  applied_courses SET university_approve_status='1' where ID='$stud_id'";
...
echo "<script>alert('You Have Already Approved!!');</script>";		
}
