...
<?php        
		...
		?>
                 ...
                 <th data-priority="1">Pictorial Description </th>                                        
...
'bitch','ww','cum','hacker', '<','>','asd','qwea','sds','vdad','dff','asdad','asd','sdzxc','dfxcv','>xcv','xcv','xcvx','sfsre'); 
  ...
  $sql = $obj->db->prepare("select * from  agent_message ORDER BY ID DESC");
...
if($spamProbability==0 && $spam==0){
			...
			?> 
                      ...
                      <td><a href="agent.php?id=<?php echo $row['ID']; ?>" class="btn btn-danger">Delete </a></td>
...
{
	echo "<script>window.location='agent.php?id1=done';</script>";
}
