                ...
                <section class="wrapper" style='margin-top:60px;display:inline-block;width:100%;padding:15px 0 0 15px;'>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">State Admin Create</h1>                            </div>
                   ...
                   <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Add State Admin</h2>
   ...
   <br> <br>
    ...
    <label>
                Enter State Admin State
                         ...
                         <select onChange="print_state('state',this.selectedIndex);" style="" id="country" name ="state" class="form-control" required ></select><br>
	                     </div> 
						<div class="col-lg-10 field">
						<label>
               Select City
                            </label><select name="city" id ="state" style=" " class="form-control" required> 
...
</form> <h3>Created State Admin</h3> <table cellspacing="0" id="tech-companies-1" class="table table-small-font table-bordered table-striped">
                                                <thead>
                                                    <tr>
...
include 'Application/DB_Functions.php'; // Here we just call the ADB_Fuctions file for provinding the connection
  ...
  $sql = $obj->db->prepare("select * from state_admin");
...
if($obj->Add_state_admin($username,$password,$state,$city)==1)
{	

echo "<script type='text/javascript'>
alert('State Admin Added to Database!!');
</script>";
echo "<script>window.location='State-Admin.php';</script>";
