...
VALUES(:branch,:subject,:sem)");
 ...
 function Add_state_admin($username,$password,$state,$city){
          //$status = 0;
	
//$db = new PDO('mysql:host=localhost;dbname=hostelakola;charset=utf8', 'root', '');
$sql = $this->db->prepare("INSERT INTO `state_admin` (`username`, `password`, `state`, `city`) VALUES(:username,:password,:state,:city)");
